...
public class VideoCompensation extends JFrame
{
    BufferedImage image, image2; //used to load the images 
    BufferedImage[] recimage = new BufferedImage [4]; // holds the "processing" video for animation
    ...
    public VideoCompensation () throws Exception//initializes the frame and attributes of VideoCompensation
    {
	setSize (860, 760);
	setLocation (0, 0);
