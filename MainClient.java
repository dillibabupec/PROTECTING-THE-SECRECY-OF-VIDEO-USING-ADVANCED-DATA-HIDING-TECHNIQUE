...
private static JFrame dummyFrame = new JFrame();
	...
	public MainClient()
	{
		...
		lblLogo= new JLabel(new ImageIcon(this.getClass().getResource("")));
		btnEmbedMessage= new MyJButton("D:\\Vinoth\\Netbeans Project\\Convert_Gray_Image\\src\\Images\\EmbedMessage", "D:\\Vinoth\\Netbeans Project\\Convert_Gray_Image\\src\\Images\\EmbedMessageHover");
		btnEmbedFile= new MyJButton("D:\\Vinoth\\Netbeans Project\\Convert_Gray_Image\\src\\Images\\EmbedFile", "D:\\Vinoth\\Netbeans Project\\Convert_Gray_Image\\src\\Images\\EmbedFileHover");
		btnRetrieveMessage= new MyJButton("D:\\Vinoth\\Netbeans Project\\Convert_Gray_Image\\src\\Images\\RetrieveMessage", "D:\\Vinoth\\Netbeans Project\\Convert_Gray_Image\\src\\Images\\RetrieveMessageHover");
		btnRetrieveFile= new MyJButton("D:\\Vinoth\\Netbeans Project\\Convert_Gray_Image\\src\\Images\\RetrieveFile", "D:\\Vinoth\\Netbeans Project\\Convert_Gray_Image\\src\\Images\\RetrieveFileHover");
		btnHelp= new MyJButton("Images/Help", "D:/visual crypto/visual crypto/src/Images/HelpHover");
		btnAbout= new MyJButton("Images/About", "D:/visual crypto/visual crypto/src/Images/AboutHover");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(source== mnuExit)
		{
			int result= JOptionPane.showConfirmDialog(mainFrame, "Are you sure that you want .", "Confirm Exit", JOptionPane.YES_NO_OPTION);
			if(result== JOptionPane.YES_OPTION)
			{
				JOptionPane.showMessageDialog(mainFrame, "Thanks for using .\nPlease  :)", "From the Author", JOptionPane.INFORMATION_MESSAGE);
				System.exit(0);
			}
		}
	}
	...
	{
		JOptionPane.showMessageDialog(mainFrame, "Thanks  :)", "", JOptionPane.INFORMATION_MESSAGE);
	}
