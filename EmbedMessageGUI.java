...
public class EmbedMessageGUI extends JFrame implements ActionListener, ItemListener {
    ...
    public EmbedMessageGUI(BackEndHandler client) {
        super("Embedding message - Cryptograph " + CPT.VERSION + "   ");
        ...
        gbc.gridx = 2;
        gbl.setConstraints(txtMasterFile, gbc);
        panelFiles.add(txtMasterFile);
        gbc.gridx = 3;
        gbl.setConstraints(lblMasterSize, gbc);
        panelFiles.add(lblMasterSize);
        gbc.gridx = 4;
        gbl.setConstraints(lblMasterFileSize, gbc);
        panelFiles.add(lblMasterFileSize);
        gbc.gridx = 5;
        gbl.setConstraints(lblFiller[0], gbc);
        panelFiles.add(lblFiller[0]);
        gbc.gridx = 6;
        gbl.setConstraints(lblOutput, gbc);
        panelFiles.add(lblOutput);
        gbc.gridx = 7;
        gbl.setConstraints(txtOutputFile, gbc);
        panelFiles.add(txtOutputFile);
        gbc.gridx = 8;
        gbl.setConstraints(lblOutputSize, gbc);
        panelFiles.add(lblOutputSize);
        gbc.gridx = 9;
        gbl.setConstraints(lblOutputFileSize, gbc);
        panelFiles.add(lblOutputFileSize);

        gbc.gridx = 2;
        gbc.gridy = 2;
        gbl.setConstraints(btnChangeMasterFile, gbc);
        panelFiles.add(btnChangeMasterFile);
        gbc.gridx = 7;
        gbl.setConstraints(btnChangeOutputFile, gbc);
        ...
        gbc.gridy = 4;
        gbl.setConstraints(lblFiller[4], gbc);
